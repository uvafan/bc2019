...
export var EXTRA_FUEL_SAVINGS=3;
export var EXTRA_KARB_SAVINGS=1.5;

//new defense stuff
export var LATTICE_CANDIDATES=30;
export var ATTACK_NOW=800;
export var MAKE_STUFF=920;
export var NUM_ROUNDS=1000;
export var USE_LATTICE=1;

//signaling stuff
export var RANDOM_ONE=23125;
export var RANDOM_TWO=37272;
export var MAKE_STUFF_SIGNAL=44246;
