...
export class Castle extends Structure{
    constructor(rc){
        ...
        this.otherCastleLocs = []; this.enemyCastleLocs.push(this.reflect(this.me.x,this.me.y));
        this.objectives = [];
        this.lastObjIdx = -1;
        this.lastIds = [];
    ...
    getInitialStrategy(){
        this.strat = new strategies.DefendAndHarassOnePreacher(this);
    }
    ...
    turn(rc){
        ...
        if(obj.getPriority(this.strat,this.rc.karbonite,this.rc.fuel)>1 && (this.me.turn<4||this.me.turn%(this.otherCastleLocs.length+1)==this.myCastleNum)){
    ...
    updateMiningObjectives(){
        ...
        for(var i=0;i<this.objectives.length;i++){
            ...
            if(obj.type>1){
                ...
                else if(d==this.manhattan(obj.target[0],obj.target[1],this.enemyCastleLocs[0][0],this.enemyCastleLocs[0][1])){
